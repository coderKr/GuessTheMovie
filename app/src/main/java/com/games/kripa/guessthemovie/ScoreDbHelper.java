...
public class ScoreDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE IF NOT EXISTS " + ScoreContract.ScoreEntry.TABLE_NAME + " (" +
                    ...
                    ScoreContract.ScoreEntry.COLUMN_NAME_LOST_MATCHES + TEXT_TYPE + COMMA_SEP +
                    ScoreContract.ScoreEntry.COLUMN_NAME_STATUS + TEXT_TYPE +
                    " )";
    ...
    private static final String SQL_DELETE_ENTRIES =
            "DELETE * FROM " + ScoreContract.ScoreEntry.TABLE_NAME;
